...
function draw () {
  for (whichHour=0; whichHour<data.hours.length; whichHour++){
    ...
    ellipse (random(100, 150), random (150, 500), size, size);
    //angle++;
    ...
    rect(random(100, 150), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(100, 150), random(150, 500), size, size);
...
fill (instagramCol);
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(270, 320), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(270, 320), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(270, 320), random(150, 500), size, size);
    ...
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(440, 490), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(440, 490), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(440, 490), random(150, 500), size, size);
    ...
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(610, 660), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(610, 660), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(610, 660), random(150, 500), size, size);
    ...
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(780, 830), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(780, 830), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(780, 830), random(150, 500), size, size);
    ...
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(950, 1000), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(950, 1000), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(950, 1000), random(150, 500), size, size);
    ...
    size = data.hours[whichHour].instagram*sizeMultiplier;
    //ellipse (data[whichHour], whichHour*yplay, whichHour*20, size, size);
    ellipse (random(1120, 1170), random (150, 500), size, size);
    //angle++;
    ...
    fill (snapchatCol);
    size = data.hours[whichHour].snapchat*sizeMultiplier; 
    rect(random(1120, 1170), random(150, 500), size, size);
    
    fill (facebookCol);
    size = data.hours[whichHour].facebook*sizeMultiplier; 
    square (random(1120, 1170), random(150, 500), size, size);
