...
// https://editor.p5js.org/michaelblum/sketches/Sy53DAzCb // sliders
// https://creative-coding.decontextualize.com/browser-controls/
// https://editor.p5js.org/amena91/sketches/HJrUob3TW //buttons & styles
...
var textchange;
var instaslider, messslider, snapslider, sizeslider, rotateslider;
var col2;
var words;
var value;
...
function setup() {
  ...
  rotateslider = createSlider (0, 50, 100);
...
function draw (){
  ...
  if (mode==0) {
    ...
    text ('Press ENTER to Begin', width/2 - 78, height/2 -190);
   
    noFill ();
    strokeWeight (1);
    stroke (0);
   rect (width/2 -155, height/2 -181, 155, 40, 50);
   noLoop ();
